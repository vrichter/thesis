...
fun_write_all_out <- function(){
  ...
  fun_write_plot_tex(plot_nn_f1_class, 'role-nn-f1-class.tex', hfac=1.8*plot_height_factor_golden_ratio)
  fun_write_plot_tex(plot_nn_acc_f1_less, 'role-nn-acc-f1-less.tex', hfac=2.0*plot_height_factor_golden_ratio)
  fun_write_plot_tex(plot_nn_f1_class_less, 'role-nn-f1-class-less.tex', hfac=2.0*plot_height_factor_golden_ratio)
  fun_write_plot_tex(plot_nn_f1_class_long, 'role-nn-f1-class-long.tex', hfac=2.0*plot_height_factor_golden_ratio)
  fun_write_plot_tex(plot_cm_models, 'role-cm.tex', hfac=1.2*plot_height_factor_golden_ratio)
