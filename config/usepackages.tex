...
[ % left pages
  ...
  \begin{tabular}{>{\RaggedLeft\hspace{0pt}}p{.612\marginparwidth}>{\RaggedLeft\hspace{-2pt}}p{1em}}
...
{ % right pages
  {\setlength{\tabcolsep}{2pt}
  \begin{tabular}{>{\RaggedRight\hspace{-2pt}}p{1em}>{\RaggedRight\hspace{0pt}}p{.612\marginparwidth}}
...
%\newcommand{\newdefmanual}[2]{}
\newcommand{\newdefmanual}[2]{\mnote{}{\faEdit}\emph{#2}}
