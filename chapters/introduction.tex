...
Compressed video and audio streams are created and accessible via~\citesoftware{gstreamer} and distributed via the RTP protocol~\cite{RFC3550}.
...
In the following chapter, I introduce the topic of human \glsatt{conversation} behaviour in focused and \gls{unfocused interaction} from the viewpoint of social sciences.
